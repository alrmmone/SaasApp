        ...
        <div class="row justify-content-center mt-4">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('users.update',['item'=>$item->id]) }}" method="POST" class="row g-3 needs-validation" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control" id="count" name="count"
                                       placeholder="count" value="{{ $item->count }}" required>
                            </div>
                            <div class="col-md-3">
