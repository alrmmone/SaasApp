                    ...
                    <div class="card-header">
                        <div class="row">
                             <div class="d-flex flex-row-reverse">
                                ...
                                <h5 class="col">{{ __('Edit Place') }}</h5>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.places.update',['place'=>$place->id]) }}" method="post" class="row g-3 needs-validation">
                            @csrf
                            @method('PUT')

                            <div class="col-md-6">
                                <label for="validationCustom01" class="form-label">Place Name :</label>
                                <input type="text" class="form-control" id="name" name="name" value="{{ $place->name }}" placeholder="Name" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                <label for="validationCustom03" class="form-label">Admin Place :</label>
