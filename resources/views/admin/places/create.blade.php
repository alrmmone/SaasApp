...
@section('content')
    ...
    @if(Session::has('place_success'))
        <div class="alert alert-success" role="alert">
            {{ Session::get('place_success')   }}
        </div>
    @endif
    ...
    <div class="container">
        <div class="row justify-content-center mt-4">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Add Place') }}</div>
                    ...
                    <div class="card-body">
                        <form action="#" method="POST" class="row g-3 needs-validation">
                            ...
                            <div class="col-md-3">
                                <label for="validationCustom05" class="form-label">Access</label>
